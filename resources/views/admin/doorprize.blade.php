    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="card shadow-lg h-100" style="border-radius:20px;background-color:#277BC0">
                <div class="card-body p-3 d-flex flex-column align-items-center justify-content-center" id="hidds">
                    {{-- <div class="row d-flex align-items-center justify-content-center"> --}}
                        <h3 class="text-light text-center label-1 display-5">Selamat Kepada Pemenang</h3>
                        <h3 id="pemenangName" class=" text-center text-light header-1 display-3"></h3>
                        {{--
                    </div> --}}
                </div>
            </div>
...
<script>
    ...
    function updateDisplay(response) {
        ...
        if(response.hadiah == null) alert('kosong');
        // console.log(response.pesertaDaftar[0])
        ...
        if (response.hadiah.foto) {
            ...
            $('#gambarHadiah').html('<img src="/storage/images/' + fotoUrl + '" width="300px" alt="Foto Hadiah">');
        ...
        var pemenangNames = ""; // Membuat string kosong untuk menampung nama peserta
