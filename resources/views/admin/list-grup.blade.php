                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('admin.grup.delete', ['id' => $g->id])}}" class="btn btn-danger"><i
            ...
            <form action="{{route('admin.grup.add')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_grup') is-invalid @enderror" id="nama_grup"
                            name="nama_grup">
                        @error('nama_grup')
...
<!-- Modal Hadiah EDIT -->
@foreach ($grups as $g)
<div class="modal fade text-dark" id="grupEdit{{$g->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
