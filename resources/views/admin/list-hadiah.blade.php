...
@section('content')
<div class="container">
    <div class="card pt-3 shadow-lg" style="border-radius:20px;">
        <div class="card-body">
            <div class="container">
                ...
                <table id="hadiah" class="table text-white">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$h->nama_hadiah}}</td>
                            <td><img src="{{ Storage::url('images/' . $h->foto) }}" width="90px;"></td>
                            <td>{{ $h->jumlah }}</td>
                            <td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.hadiah.delete.do', ['id' => $h->id])}}"
                                    class="btn btn-danger"><i class="fa-regular fa-trash-can"></i></a>
                                <a href="{{ route('admin.generate.pemenang', ['id' => $h->id])}}"
...
<div class="modal fade text-dark" id="hadiahAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.hadiah.add.do')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="numberic" class="form-control @error('jumlah') is-invalid @enderror" id="jumlah"
                            name="jumlah">
                        @error('jumlah')
                        <div class="invalid-feedback">
                            {{ $message}}
...
<div class="modal fade text-dark" id="hadiahEdit{{$h->id}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('admin.hadiah.edit.do', [ 'id' => $h->id ])}}" method="POST"
